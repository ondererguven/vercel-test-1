...
export default function Navigation() {
  ...
  const services = [
    { key: "talentManagement", href: "talent-management" },
    { key: "brandConsulting", href: "brand-consulting" },
    { key: "influencerMarketing", href: "influencer-marketing" },
    { key: "brandEventActivations", href: "brand-and-event-activations" },
  ]
